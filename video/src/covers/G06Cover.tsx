// g06 教培托管 · 封面（按最新封面规范：只标题+副标题，零 UI 组件，红底珊瑚橙）
...
export const G06CoverDy: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 60, right: 60, top: 420, textAlign: 'center' }}>
      <MainTitle size={156} lines={['1 节课，', '胜过一张传单']} />
      <div style={{ marginTop: 52 }}>
        <SubLine size={52}>托管班开学季拉新方法</SubLine>
      </div>
    </div>
  </AbsoluteFill>
);
...
export const G06CoverXhs: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 56, right: 56, top: 280, textAlign: 'center' }}>
      <MainTitle size={128} lines={['1 节课，', '胜过一张传单']} />
      <div style={{ marginTop: 42 }}>
        <SubLine size={42}>托管班开学季拉新方法</SubLine>
      </div>
    </div>
  </AbsoluteFill>
);
...
export const G06CoverSohu: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 180, top: 220 }}>
      <MainTitle size={124} lines={['1 节课，', '胜过一张传单']} />
      <div style={{ marginTop: 48 }}>
        <SubLine size={48}>托管班开学季拉新 · 体验课引流</SubLine>
      </div>
    </div>
  </AbsoluteFill>
);
