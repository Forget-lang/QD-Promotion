// g08 火锅 · 封面（按最新封面规范：只标题+副标题，零 UI 组件，红底珊瑚橙）
...
export const G08CoverDy: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 60, right: 60, top: 420, textAlign: 'center' }}>
      <MainTitle size={156} lines={['7 天假期，', '过完就空？']} />
      <div style={{ marginTop: 52 }}>
        <SubLine size={52}>火锅店节后留客用档期券</SubLine>
      </div>
    </div>
  </AbsoluteFill>
);
...
export const G08CoverDy43: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 90, top: 220 }}>
      <MainTitle size={114} lines={['7 天假期，', '过完就空？']} />
      <div style={{ marginTop: 40 }}>
        <SubLine size={42}>火锅店节后留客用档期券</SubLine>
      </div>
    </div>
  </AbsoluteFill>
);
...
export const G08CoverXhs: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 56, right: 56, top: 280, textAlign: 'center' }}>
      <MainTitle size={128} lines={['7 天假期，', '过完就空？']} />
...
export const G08CoverSohu: React.FC = () => (
  <AbsoluteFill style={{ fontFamily: FONT_TITLE }}>
    ...
    <div style={{ position: 'absolute', left: 180, top: 220 }}>
      <MainTitle size={124} lines={['7 天假期，', '过完就空？']} />
      <div style={{ marginTop: 48 }}>
        <SubLine size={48}>火锅店节后留客 · 档期券锁客</SubLine>
      </div>
    </div>
  </AbsoluteFill>
);
