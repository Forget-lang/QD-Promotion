  ...
  scenes: [
    ...
    // 布局来源：ref-16 骨架不变，只把内容从"把试用写成一张券"换成这套攻略的三招全景。
    {
      ...
      payload: {
        ...
        sub: '一个痛点，两张券，一个开关',
        rows: [
          { act: '兑换券 · 开门', desc: '「来试一次」写成一张券', res: '券在家长卡包里，写着能用到几号', mark: '第一招' },
          { act: '满减券 · 锁单', desc: '只给谈过的这几家', res: '名单外的家长，在这张券上领不到', mark: '第二招' },
          { act: '转赠奖励 · 带人', desc: '家长把券转给同学家长', res: '对方核销完，家长自动得一张奖励券', mark: '第三招' },
        ],
      },
    },
    // ── S4 制券① 兑换券 · 券面（沿用已验收的制券表单卡；分组标题改为我方序号）──
    {
      ...
      payload: {
        ...
        foot: '字段名与限制照制券页原话 · 数值为示例配置 · 类型页原话「例如：凭券兑换冷饮一杯」',
      },
    },
        ...
        groups: [
          {
            ...
            rows: [
              ...
              { k: '可用时段', v: '周一至周五 15:30–18:30', hint: '默认全天可用；定制可选周几与时段，最多 2 段', kind: 'switch', on: true },
            ],
          },
          {
            head: '④ 发放方式',
            rows: [
              ...
              { k: '每人限领总量', v: '1 张', hint: '先打开「限领总量」：每人累计领取的总张数', kind: 'input' },
            ],
          },
          {
            head: '⑤ 到期提醒',
    ...
    // ── S7 制券③ 满减券 · 券面与私密发放（复用 g06-make-basic 卡形 4+1 行）──
    {
      ...
      payload: {
        ...
        groups: [
          {
            ...
            rows: [
              ...
              { k: '消费门槛', v: '1000 元', hint: '满多少元可用 · 原话「例如：消费满100减20」', kind: 'input' },
        ...
        foot: '选了私密发放，「公开领取设置」整组和「允许分享」这行都不出现',
      },
    },
    // ── S8 满减券 · 只给名单里的号（复用 g06-ledger 两栏清单，4 句）──
    {
      ...
      subtitles: [
        ...
        { text: '私密发放这一张没有公开领取设置那组，发出去的码领完就失效。', startFrame: 378, endFrame: 523 },
      ],
      payload: {
        tag: '第二招 · 只给这几家',
        title: '指定手机号可领取',
    ...
    // ── S9 私密发放要设的数据（复用 g06-chain 时间线，3 节点 4 句）──
    {
      ...
      payload: {
        ...
        nodes: [
          { head: '面对面二维码', desc: '私密发放面板里选这一格，进来就是发放设置', note: '面板原话：适合一对一/储值回馈/消费奖励/给指定客户' },
          { head: '发放数量 · 超时时间', desc: '数量 1~10 张，一对一就填 1 张；超时时间选 1 天', note: '原话：超过有效期后，领取链接失效，需要重新发放。' },
          { head: '发放备注', desc: '写「开学第一周谈的三家」', note: '选填，仅商家可见 · 客户领完，这个码就失效' },
        ],
        foot: '画面为示例 · 字段名与限制照原话',
      },
    },
        ...
        groups: [
          {
            ...
            rows: [
              ...
              { k: '开启转赠奖励', v: '开', hint: '原话：转赠后，受赠人领取并核销后再赠选择的优惠券一张。', kind: 'switch', on: true },
    ...
    // ── S11 链路走完 + 核销页三件（复用 g06-chain 时间线，3 节点 4 句）──
    {
      ...
      payload: {
        ...
        nodes: [
          { head: 'A 转赠给 B', desc: 'A 在自己券详情点「转赠给好友」', note: '弹窗原话「仅首位领取好友可获得本券」' },
        ...
        foot: '画面为示例 · 转赠奖励是优惠券的功能 · 次卡只有转赠没有奖励',
      },
    },
    // ── S12 收尾 · 三招收口 + 后台真词（复用 g06-cta）──
    {
      ...
      payload: {
        ...
        title2: '三招设完',
        strips: [
          { name: '兑换券 · 下午托管一次', role: '开门' },
          { name: '满减券 · 只给名单里的号', role: '锁单' },
          { name: '转赠奖励 · 家长带家长', role: '带人' },
        ],
        brand: '券到卡包',
