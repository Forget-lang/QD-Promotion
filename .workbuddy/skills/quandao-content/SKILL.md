...
> 最后校验：2026-08-27（审计修订：闸门句补全为三闸门；此前完成文档架构重构阶段 3：切换到 spec/ 三真源 + workflow/ 四散文 + R2/R3）
...
- **改一处，全量对齐** —— 改完跑三闸门：`check-redlines.mjs`（code 层零命中）+ `check-doc-references.mjs`（引用零断链）+ `check-facts.mjs`（资产在位）+ 更新 changelog
