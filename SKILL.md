...
- **质感锚（2026-08-29 用户逐张认可，做屏前先看这三张图）**：`outputs/bench-bundle-open.png`（产品特写屏）· `outputs/bench-pain.png`（痛点屏）· `outputs/bench-mech.png`（机制对比屏）；实现代码在 `video/src/bench/`——新屏从这三套骨架抄结构，禁止脱离锚稿自由发挥；对不上锚稿的屏 = 回炉。
